...
- 展開済みbase sourceを変更せず、任意のJSON build manifestからlock済みsprite、costume、soundを追加
...
- [`docs/ja/project-asset-additions.md`](docs/ja/project-asset-additions.md): sprite、costume、soundを追加するJSON build入力
